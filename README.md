...
- [Superset](https://superset.sh/) — Desktop (macOS) workspace that runs many CLI coding agents in parallel, each in its own git worktree, with built-in diff review and editor handoff. 🟡 [![★](https://img.shields.io/github/stars/superset-sh/superset?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/superset-sh/superset/stargazers)
  - `superset-sh/superset` · Elastic License 2.0 · macOS · *Distinctive:* parallel orchestration of 10+ CLI agents, per-task git-worktree isolation, built-in diff viewer/editor, workspace setup/teardown presets, one-click open-in-editor handoff.
- [Paseo](https://paseo.sh/) — Self-hosted daemon that runs five coding agents (Claude Code, Codex, Copilot, OpenCode, Pi) through one interface, with desktop/mobile/web/CLI clients connecting to it. 🟡 [![★](https://img.shields.io/github/stars/getpaseo/paseo?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/getpaseo/paseo/stargazers)
  - `getpaseo/paseo` · source-available (custom license) · Desktop/iOS/Android/Web/CLI · MCP · *Distinctive:* parallel agents on your own machine, cross-device clients, voice control, remote relay for remote connectivity, orchestration skills (`/paseo-handoff`, `/paseo-loop`, `/paseo-committee`).
...
- [1code](https://1code.dev/) — Open-core desktop/web client that runs Claude Code and Codex locally or in cloud sandboxes with worktree isolation. 🟡 [![★](https://img.shields.io/github/stars/21st-dev/1code?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/21st-dev/1code/stargazers)
  - `21st-dev/1code` · Apache-2.0 (open-core) · macOS/Windows/Linux/Web/PWA · MCP · Claude Code/Codex · *Distinctive:* worktree-per-session + kanban, background/cloud sandbox execution, rollback from any message, PWA mobile control.
- [emdash](https://emdash.sh/) — Desktop app for running multiple coding-agent CLIs (Claude Code, Codex, Cursor, Gemini, Amp, and more) in parallel, each isolated in its own git worktree. 🔓 [![★](https://img.shields.io/github/stars/generalaction/emdash?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/generalaction/emdash/stargazers)
  - `generalaction/emdash` · Apache-2.0 · macOS/Windows/Linux · *Distinctive:* diff review, PR create/merge + CI inspection, issue import from Linear/GitHub/Jira/GitLab/Asana, local or remote (SSH/SFTP) execution.
- [AgentsMesh](https://agentsmesh.ai/) — Self-hosted runner fleet that runs terminal agents across multiple machines from one console (web/desktop/iOS/CLI). 🟡 [![★](https://img.shields.io/github/stars/AgentsMesh/AgentsMesh?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/AgentsMesh/AgentsMesh/stargazers)
  - `AgentsMesh/AgentsMesh` · BSL-1.1 (→ GPL-2.0) · Web/Desktop/iOS/CLI · Claude Code/Codex/Gemini CLI/Aider/OpenCode · *Distinctive:* per-pod worktree sandboxes across a machine fleet, "Autopilot" control agent, pod-to-pod Mesh & Channels with @mentions.
- [mux](https://mux.coder.com/) — Coder's desktop/browser app for running many agents in parallel in isolated workspaces, with Local / Worktree / SSH runtimes. 🔓 [![★](https://img.shields.io/github/stars/coder/mux?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/coder/mux/stargazers)
  - `coder/mux` · AGPL-3.0 · macOS/Linux/Web/VSCode · *Distinctive:* runs its own model-agnostic agent loop (multi-model), parallel agents across isolated Local/Worktree/SSH workspaces, git divergence/conflict visualization, mobile via server mode.
- [Agent Teams AI](https://agentteams.live/) — Desktop app that orchestrates teams of coding agents that message each other and review one another's code. 🔓 [![★](https://img.shields.io/github/stars/777genius/agent-teams-ai?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/777genius/agent-teams-ai/stargazers)
  - `777genius/agent-teams-ai` · AGPL-3.0 · macOS/Windows/Linux · MCP · Claude Code/Codex/OpenCode · *Distinctive:* agent-to-agent + cross-team messaging, hunk-level accept/reject diff review, 5-column kanban, live per-agent CPU/RAM dashboard.
- [Cline (Kanban)](https://cline.bot/) — Companion Kanban app from the Cline project (60k★+) that orchestrates parallel CLI agents in isolated git worktrees. 🔓 [![★](https://img.shields.io/github/stars/cline/kanban?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/cline/kanban/stargazers)
  - `cline/kanban` · Apache-2.0 · CLI/Web · auto-detects installed CLI agents · *Distinctive:* kanban board for parallel agents, ephemeral git worktree isolation per task, task dependency chains with auto-commit. (Core [Cline](https://github.com/cline/cline) is the agent; this lists the orchestrator component.)
- [claude-code-by-agents](https://claudecode.run/) — Native Swift macOS/iOS app that coordinates multiple Claude Code agents across local and remote machines via @mention routing. 🔓 [![★](https://img.shields.io/github/stars/baryhuang/claude-code-by-agents?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/baryhuang/claude-code-by-agents/stargazers)
  - `baryhuang/claude-code-by-agents` · MIT · macOS/iOS · Claude Code · *Distinctive:* @mention routing to named agents, cross-machine coordination, iMessage-style 2-pane native app.
...
- [Constellagent](https://constellagent.vercel.app/) — macOS app for running multiple AI agent sessions in parallel, each with its own terminal, Monaco editor, and isolated worktree. 🔓 [![★](https://img.shields.io/github/stars/owengretzinger/constellagent?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/owengretzinger/constellagent/stargazers)
  - `owengretzinger/constellagent` · license unconfirmed · macOS · agent-agnostic · *Distinctive:* worktree-per-agent in one window, full terminal emulator, Monaco editor with diffs, cron automations with sleep/wake recovery.
...
- [AgentsRoom](https://agentsroom.dev/) — Desktop app (with iOS/Android companions) that orchestrates CLI agents across projects as native local processes, with specialized agent roles and team handoffs. 🔒 *no public repo*
...
- [Gas Town](https://github.com/gastownhall/gastown) — Steve Yegge's multi-agent orchestration system coordinating parallel agents with git-backed work state and a watchdog hierarchy. 🔓 [![★](https://img.shields.io/github/stars/gastownhall/gastown?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/gastownhall/gastown/stargazers)
  - `gastownhall/gastown` · MIT · CLI/TUI/Web · Claude Code/Copilot/Codex/Gemini/Cursor/Amp/OpenCode/Pi · *Distinctive:* role hierarchy (Mayor → workers), "beads" git-backed issue tracker as shared memory, bors-style verifying merge queue (Go).
- [Claude Squad](https://smtg-ai.github.io/claude-squad/) — Terminal TUI that manages multiple agent instances in parallel, each in its own git worktree and tmux session. 🔓 [![★](https://img.shields.io/github/stars/smtg-ai/claude-squad?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/smtg-ai/claude-squad/stargazers)
  - `smtg-ai/claude-squad` · AGPL-3.0 · macOS/Linux/TUI · Claude Code/Codex/Gemini CLI/Aider (+ any local agent via custom program) · *Distinctive:* worktree + tmux isolation per session, diff-tab review, experimental yolo/auto-accept background mode.
...
- [dux](https://getdux.app/) — Three-pane TUI for running multiple agent CLIs in parallel, each in its own worktree, with a live git staging workflow. 🔓 [![★](https://img.shields.io/github/stars/patrickdappollonio/dux?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/patrickdappollonio/dux/stargazers)
  - `patrickdappollonio/dux` · MIT · macOS/Linux/TUI · Claude Code/Codex/OpenCode/+ · *Distinctive:* wraps the real CLIs so MCP/hooks/skills keep working, syntax-highlighted diffs + AI commit messages, PR status tracking via `gh`, session forking (Rust).
- [Agent Orchestrator](https://github.com/ComposioHQ/agent-orchestrator) — Composio's orchestrator (now ReverbCode) that supervises many parallel coding-agent sessions, each in its own git worktree, routing CI failures, review comments, and merge conflicts back to the owning agent. 🟡 [![★](https://img.shields.io/github/stars/ComposioHQ/agent-orchestrator?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/ComposioHQ/agent-orchestrator/stargazers)
  - `ComposioHQ/agent-orchestrator` · license unspecified (no LICENSE file) · CLI/Desktop · 23 agent adapters incl. Claude Code/Codex/Cursor/OpenCode/Aider/Kimi · *Distinctive:* agent-agnostic adapter registry, zellij-runtime git-worktree isolation, live GitHub PR/CI observation that nudges the owning agent (humans still merge).
...
- [Bernstein](https://bernstein.run/) — Deterministic Python orchestrator that decomposes a goal and runs CLI agents in parallel worktrees, verifying and merging with an audit chain. 🔓 [![★](https://img.shields.io/github/stars/chernistry/bernstein?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/chernistry/bernstein/stargazers)
  - `chernistry/bernstein` · Apache-2.0 · CLI/Web/VSCode/Cloud · MCP · 44 agent adapters (Claude Code/Codex/Gemini CLI/Copilot/Aider/Goose/…) · *Distinctive:* zero-LLM deterministic scheduler, verification gates (tests/lint/types), HMAC-SHA256 audit chain + Ed25519-signed agent cards, optional Cloudflare Workers execution.
...
- [Multica](https://multica.ai/) — Open-source managed-agents platform that turns coding agents into board-tracked teammates you assign issues to. 🟡 [![★](https://img.shields.io/github/stars/multica-ai/multica?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/multica-ai/multica/stargazers)
  - `multica-ai/multica` · Apache-2.0 (modified) · Web/self-hosted/Cloud · Claude Code/Codex/Copilot CLI/OpenClaw/OpenCode/Hermes/Gemini/Cursor/Pi/Kimi/Kiro/Qoder · *Distinctive:* assign issues like to a colleague, "Squads" with a leader agent that delegates, compounding reusable skills (Go).
...
- [T3 Code](https://t3.codes/) — Open-source web/desktop control plane (Theo / Ping) that orchestrates Codex, Claude Code, Cursor, and OpenCode from one interface. 🔓 [![★](https://img.shields.io/github/stars/pingdotgg/t3code?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/pingdotgg/t3code/stargazers)
  - `pingdotgg/t3code` · MIT · macOS/Windows/Linux/Web/CLI · *Distinctive:* per-thread git branch + checkpointing, one-button commit/push/PR with generated title/body, `npx t3@latest`. (Self-described "very early.")
...
- [OpenGoat](https://github.com/marian2js/opengoat) — Platform for building hierarchical organizations of agents that coordinate work across many providers. 🔓 [![★](https://img.shields.io/github/stars/marian2js/opengoat?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/marian2js/opengoat/stargazers)
  - `marian2js/opengoat` · MIT · Web (local UI)/CLI · Claude Code/Codex/Cursor/Copilot CLI/Lovable · *Distinctive:* manager→subordinate `reportsTo` hierarchy, role-based skill assignment (built on the OpenClaw engine).
- [Agent Kanban](https://agent-kanban.dev/) — Agent-first kanban board that treats agents as cryptographically identified team members who claim tasks and open PRs. 🟡 [![★](https://img.shields.io/github/stars/saltbo/agent-kanban?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/saltbo/agent-kanban/stargazers)
  - `saltbo/agent-kanban` · FSL-1.1-ALv2 (→ Apache-2.0) · CLI/Web · ACP · Claude Code/Codex/Gemini CLI/Copilot/Hermes · *Distinctive:* Ed25519 identity per agent, leader plans/assigns while workers ship PRs, agent-reviews-agent before human sign-off, deployable on Cloudflare (D1).
...
- [Oz](https://www.warp.dev/oz) — Warp's orchestration platform that runs and monitors fleets of cloud coding agents across multiple harnesses. 🟡 [![★](https://img.shields.io/github/stars/warpdotdev/warp?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/warpdotdev/warp/stargazers)
  - `warpdotdev/warp` (client; Oz backend hosted) · MIT/AGPLv3 client · Cloud/Web/Desktop/CLI · MCP · Claude Code/Codex/Gemini CLI/Warp Agent · *Distinctive:* interactive agents run locally while autonomous ones run in the cloud, self-hosted or Warp-managed, event/trigger-based runs, multi-model routing, single-pane audit trails. (★ count is for the Warp client.)
- [Centaur](https://centaur.run/) — Paradigm's self-hosted control plane that runs CLI agent harnesses inside isolated Kubernetes sandboxes, driven from Slack or an API. 🔓 [![★](https://img.shields.io/github/stars/paradigmxyz/centaur?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/paradigmxyz/centaur/stargazers)
  - `paradigmxyz/centaur` · Apache-2.0 / MIT · Cloud/CLI/Slack · Claude Code/Codex/Amp · *Distinctive:* Slack-native multiplayer agent per thread, durable Postgres-persisted execution surviving restarts, credential injection without exposing secrets, per-conversation K8s sandbox.
...
- [Crystal](https://github.com/stravu/crystal) — Electron app that ran multiple Claude Code/Codex sessions in parallel, each in its own worktree, with side-by-side comparison and diff review. 🔓 [![★](https://img.shields.io/github/stars/stravu/crystal?style=flat-square&label=%E2%98%85&color=lightgrey)](https://github.com/stravu/crystal/stargazers) `stravu/crystal` · MIT · **discontinued — now [Nimbalyst](https://nimbalyst.com/)** (repo last updated Feb 2026). Pioneered worktree-isolated multi-session Claude Code.
