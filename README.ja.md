...
- [codeg](https://github.com/xintaofei/codeg) [![★](https://img.shields.io/github/stars/xintaofei/codeg?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/xintaofei/codeg/stargazers) 🔓 — Claude Code・Codex・OpenCode・Pi・Grok Build のセッションを一つにまとめるマルチエージェント作業場。デスクトップアプリ・セルフホストサーバー・Docker で動く。`Apache-2.0` `mac/Win/Linux/self-host` `Claude Code/Codex/OpenCode`
...
- [OpenSwarm](https://github.com/unohee/OpenSwarm) [![★](https://img.shields.io/github/stars/unohee/OpenSwarm?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/unohee/OpenSwarm/stargazers) 🔓 — Claude Code CLI のワーカーをワーカー／レビュアー／テスター／ドキュメンターのパイプラインで動かす自律型の「AI 開発チーム」。Linear や GitHub の issue を取り込み、Discord から操作、長期メモリ付き。`MIT` `CLI` `Claude Code/Codex`
...
- [hcom](https://github.com/aannoo/hcom) [![★](https://img.shields.io/github/stars/aannoo/hcom?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/aannoo/hcom/stargazers) 🔓 — 複数ターミナルにまたがって AI エージェント同士がメッセージを送り合い、互いを監視・起動できる。Claude Code・Codex・Cursor CLI・OpenCode などに対応。`MIT` `CLI` `multi-agent`
- [codex-orchestrator](https://github.com/kingbootoshi/codex-orchestrator) [![★](https://img.shields.io/github/stars/kingbootoshi/codex-orchestrator?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/kingbootoshi/codex-orchestrator/stargazers) 🔓 — tmux セッション上の OpenAI Codex エージェントにタスクを振り分ける。Claude Code から動かす前提の設計。`MIT` `CLI/tmux` `Codex`
...
- [opencode-ensemble](https://github.com/hueyexe/opencode-ensemble) [![★](https://img.shields.io/github/stars/hueyexe/opencode-ensemble?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/hueyexe/opencode-ensemble/stargazers) 🔓 — OpenCode 向けのエージェントチーム。複数エージェントを並列で走らせ、メッセージングと共有タスクで協調させる。`MIT` `CLI` `OpenCode`
...
- [kodo](https://github.com/ikamensh/kodo) [![★](https://img.shields.io/github/stars/ikamensh/kodo?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/ikamensh/kodo/stargazers) 🔓 — Claude Code・Cursor・Codex・Gemini など複数のコーディングエージェントをまとめて動かすオーケストレーター。`MIT` `CLI` `Claude Code/Cursor/Codex/Gemini`
...
- [jmux](https://jmux.build/) [![★](https://img.shields.io/github/stars/jarredkenny/jmux?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/jarredkenny/jmux/stargazers) 🔓 — コーディングエージェントを並列で走らせる tmux 環境。各セッションの状況と要対応箇所を常時サイドバーに表示する。`AGPL-3.0` `CLI/tmux`
...
- [kanbots](https://kanbots.dev/) [![★](https://img.shields.io/github/stars/leodavinci1/kanbots?style=flat-square&label=%E2%98%85&color=2ea043)](https://github.com/leodavinci1/kanbots/stargazers) 🔓 — 各タスクが Claude Code か Codex のエージェントになるローカルのカンバンボード。`MIT` `self-host` `Claude Code/Codex`
...
- [1code](https://1code.dev/) [![★](https://img.shields.io/github/stars/21st-dev/1code?style=flat-square&label=%E2%98%85&color=lightgrey)](https://github.com/21st-dev/1code/stargazers) — Claude Code と Codex をローカル／クラウドサンドボックスで worktree 隔離して動かしたオープンコアのデスクトップ／Web クライアント。`Apache-2.0` **リポジトリはアーカイブ済み**
